...
# Load data
# Memuat dataset diabetes dari file CSV yang berisi informasi pasien dan hasil pemeriksaan diabetes.
...
# Train model
# Memulai proses pelatihan model dengan menggunakan data pelatihan (X_train, y_train).
...
# Evaluate model
# Menilai performa model dengan menggunakan data pengujian (X_test, y_test).
...
# Save model
# Menyimpan model yang telah dilatih untuk keperluan penggunaan kembali di kemudian hari.
...
# Save test data
# Menyimpan data hasil pengujian (X_test dan y_test) untuk referensi atau analisis lebih lanjut.
